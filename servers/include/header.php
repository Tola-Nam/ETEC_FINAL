    ...
    <body class="bg-gray-100 flex">
        ...
        <div class="w-64 bg-gray-800 text-white min-h-screen p-4">
            ...
            <div class="relative mt-2">
                ...
                <div id="dropdownMenu"
                    class="absolute left-0 w-full text-gray-900 border-0 rounded-md shadow-lg hidden">
                    <a href="#" class="block px-4 py-2 hover:bg-green-200 btn btn-outline-success mb-2">login</a>
                    <a href="#" class="block px-4 py-2 hover:bg-blue-200 btn btn-outline-primary mb-2">Register</a>
                    <a href="#" class="block px-4 py-2 hover:bg-red-200 btn btn-outline-danger">Logout<i
