    ...
    public function insertproduct()
    {
        try {
            ...
            if (!empty($this->product_title) || !empty($this->product_price) || !empty($this->stock) || !empty($this->category) || !empty($this->product_description) || !empty($this->filename)) {
                $insertproduct = "INSERT INTO `goods` ( `product_title`, `product_price`,`stock`,`category`,`product_description`,`product_thumbnail`,`author_id`)
                ...
                try {
                    $inserQuery = connectiondatabase()->query($insertproduct);
                    if (empty($inserQuery)) {
