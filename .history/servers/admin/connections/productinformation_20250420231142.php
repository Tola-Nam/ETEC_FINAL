...
try {
    ...
    if (!empty($_SERVER['REQUEST_METHOD']) == "POST") {
        ...
        if (!empty($_POST)) {
            ...
            $product_information = new Productin_formation($product_title, $product_price, $stock, $category, $product_description, $filename, $author_id);
        }
