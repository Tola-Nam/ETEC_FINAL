...
<body class="bg-gray-100">
    ...
    <div id="sidebar">
        ...
        <div class="relative mt-2">
            ...
            <div id="dropdownMenu" class="position-absolute w-100 bg-white text-dark rounded shadow d-none">
    <a href="#" class="dropdown-item text-success">Login</a>
    <a href="#" class="dropdown-item text-primary">Register</a>
    <a href="#" class="dropdown-item text-danger d-flex justify-content-between align-items-center">
